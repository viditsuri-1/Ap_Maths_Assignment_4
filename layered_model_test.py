...
def test_define_dense_model_single_layer():
    ...
    assert model.layers[1].units == 1, "output_shape is not correct"
...
def test_define_dense_model_with_hidden_layer():
    ...
    assert model.input_shape == (None, 43), "input_shape is not correct"
    assert model.layers[1].units == 11, "hidden layer output_shape is not correct"
    assert model.layers[2].units == 1, "output layer output_shape is not correct"
